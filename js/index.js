...
(function () {
    ...
    var option = {
        ...
        legend: {
            ////如果series 对象有name值，则legend可以不用与data
            textStyle: {
                color: '#4c9bfd', // 图例文字颜色
            },
            right: '10%' // 距离右边10%
...
(function () {
    ...
    var XAData = [
        ...
        [{ name: '郑州' }, { name: '铜川', value: 100 }],
        [{ name: '郑州' }, { name: '长治', value: 100 }],
        [{ name: '郑州' }, { name: '广州', value: 100 }],
        [{ name: '郑州' }, { name: '西宁', value: 100 }],
        [{ name: '郑州' }, { name: '鄂尔多斯', value: 100 }],
        [{ name: '郑州' }, { name: '深圳', value: 100 }],
        [{ name: '郑州' }, { name: '肇庆', value: 100 }],
        [{ name: '郑州' }, { name: '淄博', value: 100 }],
        [{ name: '郑州' }, { name: '盘锦', value: 100 }],
        [{ name: '郑州' }, { name: '莱芜', value: 100 }],
        [{ name: '郑州' }, { name: '重庆', value: 100 }],
        [{ name: '郑州' }, { name: '连云港', value: 100 }],
        [{ name: '郑州' }, { name: '肇庆', value: 100 }],
        [{ name: '郑州' }, { name: '玉溪', value: 100 }],
    ...
    var series = [];
    [['郑州', XAData], ['西宁', XNData], ['拉萨', YCData]].forEach(function (item, i) {
        series.push({
            name: item[0] + ' Top3',
            type: 'lines',
            zlevel: 1,
